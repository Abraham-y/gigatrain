...
| gigabpe @ 1 GB ByteLevel | 8.5 s / 10.22 s / 14.9 s | **6.7 s** (one-session) | three separate sessions; ratios built on them were never mutually comparable |
...
and gigabpe is fastest at 100 MB and 1 GB. The claim is supportable *with
...
3.9x**, because gigabpe's own baseline shifted 7.1 s → 6.7 s between two
...
- **fast-bytelevel-bpe-go's speed is not comparable to anything** — its corpus
  ...
  slower than gigabpe" had no basis.
